...
# require 'simple_enum'  # Commented temporarily to resolve dependency issues
...
class DmsfLock < ApplicationRecord
  ...
  # as_enum :lock_type, %i[type_write type_other]  # Commented temporarily
  # as_enum :lock_scope, %i[scope_exclusive scope_shared]  # Commented temporarily
